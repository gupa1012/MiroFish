...
[English](./README-EN.md) | [中文文档](./README.md) | [Deutsch：VS Code + GitHub Copilot 指南](./docs/VS-CODE-COPILOT-DE.md)
...
> 如果你所在的企业环境无法安装完整依赖，但希望在 VS Code 中借助 GitHub Copilot 复用 MiroFish 的多智能体思路，可以参考这份德文轻量实践指南：[VS Code + GitHub Copilot 指南](./docs/VS-CODE-COPILOT-DE.md)
